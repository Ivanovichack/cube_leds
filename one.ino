...
void personal1()
{
  for(int x = 32; x != 0; x -=4)
  {  
    for(int j = 0; j <4;j++){
      turnEverythingOffm(j);
...
void gira_fuera_dentro()
{
  for(int x = 45; x != 0; x -=15)
  {  
